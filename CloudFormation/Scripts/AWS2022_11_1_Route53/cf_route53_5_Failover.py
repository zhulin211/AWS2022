...
if __name__ == "__main__":
    template_path_use = '../../AWS2022_11_1_Route53/route53_5_Failover_1_use_Primary.yaml'
    template_path_usw = '../../AWS2022_11_1_Route53/route53_5_Failover_2_usw_Secondary.yaml'
    stack_name_use = 'Route53FailoverUSE'
    stack_name_usw = 'Route53FailoverUSW'
    parameters_use = [
